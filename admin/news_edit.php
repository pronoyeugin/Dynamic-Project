...
$nid    = htmlspecialchars($_POST['n_id']);
$ntitle = htmlspecialchars($_POST['n_title']);
$nicon  = $_POST['n_icon'];
$ndesc  = htmlspecialchars($_POST['n_desc']);
$cid    = $_POST['c_id'];

$update_sql = "UPDATE `news` SET `title`='$ntitle',`icon`='$nicon',`description`='$ndesc',`c_id`=$cid WHERE id=$nid";
        ...
        <div class="container-fluid px-4">
          ...
          <div class="card mb-4">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'];?>"method="post">
              ...
              <div class="mb-3">
                <label for="c_icon" class="form-label">News Icon</label>
                <input value=" <?php  echo $final['icon']; ?>" type="text" class="form-control" id="c_icon" name="n_icon" required>
              </div>
              <div class="mb-3">
                <label for="n_desc" class="form-label">News Description</label>
                <textarea class="form-control" id="n_desc" rows="3" name="n_desc" required ><?php  echo $final['description']; ?></textarea>
              </div>
              <div class="mb-3">
