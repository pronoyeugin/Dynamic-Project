...
if( isset($_POST['n_submit']) ){
  ...
  $ntitle = htmlspecialchars($_POST['n_title']);
  $nicon  = htmlspecialchars($_POST['n_icon']);
  $ndesc  = htmlspecialchars($_POST['n_desc']);
  $cid    = $_POST['c_id'];
  ...
  if ( $npass == $cpass ){
    ...
    $insert_sql = "INSERT INTO `news`(`title`, `icon`, `description`, `pass`, `c_id`) VALUES
    ('$ntitle', '$nicon', '$ndesc', '$npass', $cid )";
    
    if( $conn -> query ($insert_sql ) ) {

      $result = "<h3 class ='text-success'>" . "Data inserted sucessfully" . "<h3>";
          ...
          <div class="card mb-4">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'];?>"method="post">
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control" id="n_desc" rows="3" name="n_desc" required ></textarea>
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                <button type="submit" class="btn-success w-25" name="n_submit">Submit</button>
                <button type="reset"class="btn-danger w-25" >Submit</button>
              </div>
