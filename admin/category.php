    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid px-4">
          ...
          <div class="card mb-4">
            <div class="card-body">
            <h2 class="mb-3">Insert Category</h2>
            <form action="<?php echo $_SERVER['PHP_SELF'];?>"method="post">
              ...
              <div class="mb-3">
                <button type="submit" class="btn-success w-25" name="c_submit">Submit</button>
          ...
          <div class="card mb-4">
            <div class="card-body">
              <h2 class="mb-3">Category Info</h2>
              <table id="datatablesSimple">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="category_edit.php?id=<?php echo $final ['id'] ?>">Edit</a>
                      <a href="category_delete.php?id=<?php echo $final ['id'] ?>">Delete</a>
                    </td>
                  </tr>
                  <?php } ?>
                  <?php } else{ ?>
